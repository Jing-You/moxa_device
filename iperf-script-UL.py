...
if __name__ == '__main__':
    ...
    while (check == 'true\n') :
        ...
        print(r'iperf3 -c 140.112.20.183 -p 3230 -u -V -t 7200 --logfile ./iperf3_log/UL-'+ str(number) + '-' + n )
        os.system(r'iperf3 -c 140.112.20.183 -p 3230 -u -V -t 7200 --logfile ./iperf3_log/UL-'+ str(number) + '-' + n )
        file= open('enable','r')
        check=file.readline()
        file.close()
        number+=1
